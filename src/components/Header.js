...
function Header() {
    ...
    const userPhoto = useSelector((state) => state.userSlice.photo);
    ...
    function setUser(user) {
        dispatch(
            userActions.setUserLoginDetails({ name: user.displayName, email: user.email, photo: user.photoURL })
        )
    }
    return (
        <Nav>
